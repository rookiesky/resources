...
<div class="list-rounded">
    <div class="list-item list-overlay-content">
        <div class="media">
            <a class="media-content" href="<?php the_permalink() ?>" target="_blank" style="background-image:url('<?php echo pandapro_the_thumbnail(null, array('w' => 400, 'h' => 400)) ?>')"><span class="overlay-1"></span></a>
