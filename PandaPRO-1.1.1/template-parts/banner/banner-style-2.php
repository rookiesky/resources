                ...
                <?php foreach($slides as $slide): ?>
                    <div class="card item list-item list-overlay-content m-0">
                        <div class="media media-21x9">
                            <a class="media-content" target="_blank" href="<?php echo $slide['link']['url'] ?>" style="background-image: url(<?php echo timthumb($slide['image'], array('w' => 1200, 'h' => 514.3)) ?>)"><div class="overlay-grad"></div></a>
                        </div>
