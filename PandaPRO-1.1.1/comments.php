...
?>
	<div id="comments" class="comments">
		<div class="my-3">
			<i class="text-xl text-primary iconfont icon-message--line mr-2"></i><span class="text-sm align-middle"><?php $pandapro_comment_count = get_comments_number();echo esc_html__( 'Comments', 'pandapro' );echo ' <small class="font-theme text-muted">('.number_format_i18n( $pandapro_comment_count ).')</small>';?></span>
		</div>
		<div class="card">
			<div class="card-body">
