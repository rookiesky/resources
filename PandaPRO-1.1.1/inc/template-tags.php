...
function pandapro_the_sticky_tag() {
	if ( is_sticky() ) {
		echo '<span class="badge badge-hot">'.__('Recommended', 'pandapro').'</span>';
	}
}
endif;
...
if ( ! function_exists( 'pandapro_the_author_like_count' ) ) :
	function pandapro_the_author_like_count($id, $echo = true) {
		...
		if ($echo) echo format_big_numbers($author_like_count); else return $author_like_count;
	}
endif;
...
if ( ! function_exists( 'pandapro_the_author_comment_count' ) ) :
	function pandapro_the_author_comment_count($id, $echo = true) {
		...
		if ($echo) echo format_big_numbers($author_comment_count); else return $author_comment_count;
	}
endif;
