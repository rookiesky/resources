					...
					<div class="list-cover list-rounded mb-3 mb-md-4">
						<div class="list-item list-overlay-content overlay-hover bg-dark">
							<div class="media media-21x9">
								<div class="media-content" style="background-image:url('<?php pandapro_the_category_cover($category->term_id) ?>')"><div class="overlay-grad"></div></div>
							</div>
							<div class="list-content p-3">
								<div class="list-body">
									<div class="d-flex align-items-center">
										...
										<div class="text-light"> <i class="text-xl iconfont icon-file-text-line mr-1"></i><span class="text-xs align-middle"><?php echo $category->count ?> <?php _e('posts', 'pandapro') ?></span></div>
									</div>
